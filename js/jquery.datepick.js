...
function Datepick() {
	...
	this.regional[''] = { // Default regional settings
		...
		'Лип','Сер','Вер','Жов','Лис','Гру'], // For formatting
		monthStatus: 'Show a different month', // Status text for selecting a month
		yearStatus: 'Show a different year', // Status text for selecting a year
		weekHeader: 'Не', // Header for the week of the year column
		weekStatus: 'Week of the year', // Status text for the week of the year column
		dayNames: ['неділя','понеділок','вівторок','середа','четвер','п\'ятниця','субота'], // For formatting
		dayNamesShort: ['нед','пнд','вів','срд','чтв','птн','сбт'], // For formatting
		dayNamesMin: ['Нд','Пн','Вт','Ср','Чт','Пт','Сб'], // Column headings for days starting at Sunday
		dayStatus: 'DD', // Status text for the day of the week selection
		 dateStatus: 'D, M d', // Status text for the date selection
		dateFormat: 'yy-mm-dd', // See format options on parseDate ....'dd/mm/yy'
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		minDate: 2014-01-01, // The earliest selectable date, or null for no limit
